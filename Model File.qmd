...
One can use a classification tree if they want an easy to interpret visual representation of the decision making process. Classification trees can be used if the response variable is categorical, binary. This process took about 20 minutes for my computer to compute. ###
